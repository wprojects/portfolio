...
########Start of Config Code
        ...
        store = FileStore(file_path='/home/zoho/5g_statuses/tokens/5g_update_radio_immediate_tokens.txt')
...
schedule.every().monday.at("06:00").do(SDKInitializer.initialize)
schedule.every().tuesday.at("06:00").do(SDKInitializer.initialize)
schedule.every().wednesday.at("06:00").do(SDKInitializer.initialize)
schedule.every().thursday.at("06:00").do(SDKInitializer.initialize)
schedule.every().friday.at("06:00").do(SDKInitializer.initialize)
schedule.every().saturday.at("06:00").do(SDKInitializer.initialize)
schedule.every().sunday.at("06:00").do(SDKInitializer.initialize)

schedule.every().monday.at("12:00").do(SDKInitializer.initialize)
schedule.every().tuesday.at("12:00").do(SDKInitializer.initialize)
schedule.every().wednesday.at("12:00").do(SDKInitializer.initialize)
schedule.every().thursday.at("12:00").do(SDKInitializer.initialize)
schedule.every().friday.at("12:00").do(SDKInitializer.initialize)
schedule.every().saturday.at("12:00").do(SDKInitializer.initialize)
schedule.every().sunday.at("12:00").do(SDKInitializer.initialize)

schedule.every().monday.at("18:00").do(SDKInitializer.initialize)
schedule.every().tuesday.at("18:00").do(SDKInitializer.initialize)
schedule.every().wednesday.at("18:00").do(SDKInitializer.initialize)
schedule.every().thursday.at("18:00").do(SDKInitializer.initialize)
schedule.every().friday.at("18:00").do(SDKInitializer.initialize)
schedule.every().saturday.at("18:00").do(SDKInitializer.initialize)
schedule.every().sunday.at("18:00").do(SDKInitializer.initialize)

schedule.every().monday.at("00:00").do(SDKInitializer.initialize)
schedule.every().tuesday.at("00:00").do(SDKInitializer.initialize)
schedule.every().wednesday.at("00:00").do(SDKInitializer.initialize)
schedule.every().thursday.at("00:00").do(SDKInitializer.initialize)
schedule.every().friday.at("00:00").do(SDKInitializer.initialize)
schedule.every().saturday.at("00:00").do(SDKInitializer.initialize)
schedule.every().sunday.at("00:00").do(SDKInitializer.initialize)
