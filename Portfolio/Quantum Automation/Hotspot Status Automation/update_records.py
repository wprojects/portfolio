...
########Start of Config Code
        ...
        """
        #Production
        token = OAuthToken(client_id='1000.IQ1VI32ANOCSK441R0VXUNPVXHGH2E', client_secret='202ce51c057945d208b300c5e032601517a15b3b37', grant_token='1000.1d8ddabd26116e5862b8f0ea9f1c8c44.587846545fa8324d1beea56bb4a9e626', redirect_url='http://localhost:8000/zoho')
        #Sanbox
        ...
        """
        store = FileStore(file_path='/home/samwins/zoho/online_offline_automation/keys/keys.txt')
