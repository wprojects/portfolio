...
#new dasboard
#old dasboard
r = requests.get('https://api.datacake.co/v1/devices/ecc2979f-01ab-4c08-b78d-2b5077a13bd5/historic_data/?fields=TEMPERATURE,HUMIDITY,PRESSURE,GAS,WIND&resolution=raw&timeframe_start='+str(yesterday)+'T00:00:00Z&timeframe_end='+str(today)+'T23:59:59Z', headers={'Authorization': 'Token '})
