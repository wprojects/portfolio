...
helium = 'https://api.datacake.co/v1/devices/ecc2979f-01ab-4c08-b78d-2b5077a13bd5/historic_data/?fields=TEMPERATURE,HUMIDITY,PRESSURE,GAS&resolution=raw&timeframe_start='+str(today)+'T10:39:00Z&timeframe_end='+str(today)+'T10:00:00Z'
...
#new dasboard
#old dasboard
r = requests.get('https://api.datacake.co/v1/devices/ecc2979f-01ab-4c08-b78d-2b5077a13bd5/historic_data/?fields=TEMPERATURE,HUMIDITY,PRESSURE,GAS,WIND&resolution=raw&timeframe_start='+str(yesterday)+'T00:00:00Z&timeframe_end='+str(today)+'T23:59:59Z', headers={'Authorization': 'Token ceede0ee65580ba31fac7b5342295f738c0bcab0'})
...
#Soil Sensor Values
r2 = requests.get('https://api.datacake.co/v1/devices/7c0df4d3-efab-4530-8df3-42af1f432cec/historic_data/?fields=SOIL_TEMPERATURE,SOIL_MOISTURE&resolution=raw&timeframe_start='+str(yesterday)+'T00:00:00Z&timeframe_end='+str(today)+'T23:59:59Z', headers={'Authorization': 'Token fb2e796d8e1dcad3fef18e2a96532c610d37fbe1'})
data2 = r2.json()
...
# Put the detail of which line is which
#ax.legend()
#loc = "center left"
#plot1.legend(loc=loc, bbox_to_anchor=(1.02, 0.5))
#plt.grid()
